...
def pizza():
    ...
    print("Tamaño de la pizza: "+tamaño)
    ...
    def guardar_pedido(nombre, apellidos, nacimiento, direccion, tamaño, i1, i2, i3, i4):
        with open("pedidos.txt", "a", encoding="utf-8") as file:
            ...
            file.write("Tamño de la pizza: " +tamaño+ "\n")
    ...
    guardar_pedido(nombre, apellidos, nacimiento, direccion, tamaño, check_i1, check_i2, check_i3, check_i4)
